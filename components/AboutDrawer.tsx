  ...
  return (
    <Drawer.Root direction="left">
      ...
      <Drawer.Portal>
        ...
        >
          <div className="bg-white dark:bg-zinc-950 h-full w-full grow p-4 flex flex-col rounded-xl shadow-xl shadow-zinc-500 dark:shadow-black/20">
              ...
              <Drawer.Description className="mb-2">
                <div className="flex items-center gap-1 my-4 p-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700">
                  ...
                  <div className="flex flex-col gap-0 pl-2">
                    ...
                    <span className="text-xs text-zinc-600 dark:text-zinc-400">View and manage timezones across the world</span>
                  </div>
                </div>
